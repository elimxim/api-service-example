...
import org.github.elimxim.domain.repository.MedicationRepository;
import org.github.elimxim.service.exception.*;
import org.github.elimxim.service.exception.*;
import org.github.elimxim.service.validator.DroneDtoValidator;
...
public class DroneDispatcher {
    ...
    public List<Drone> getDrones(boolean availableOnly) {
        List<org.github.elimxim.domain.model.Drone> drones;
        if (availableOnly) {
    ...
    public void loadMedication(Long droneId, Medication medicationDto) {
        ...
        int occupiedWeight = (int) drone.getMedications().stream()
                .map(org.github.elimxim.domain.model.Medication::getWeight)
                .count();
